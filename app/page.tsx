...
export default function Home() {
  ...
  const activeData =
    activeTab === "current"
      ? currentData
      : historyData[selectedHistoryIndex] || currentData;
      ...
      <main className="container mx-auto py-8 px-4">
        <div className="mb-2 text-center">
          ...
          <p className="text-m text-muted-foreground">
            Quantifying the seasonal greyness of Berlin
          </p>
        </div>
        ...
        <Card
          ...
          style={{ borderColor: activeData.stats.hex_color }}
        >
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
              ...
              <div className="flex items-center gap-2 bg-muted/50 px-3 py-1.5 rounded-full">
                <div
                  ...
                  style={{ backgroundColor: activeData.stats.hex_color }}
                />
                <span className="font-mono text-sm">
                  {activeData.stats.hex_color}
                </span>
              </div>
            </div>
          </CardHeader>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-muted/30 rounded-lg p-3">
                    ...
                    <p className="text-lg font-medium capitalize">
                      {activeData.stats.dominant_color}
                    </p>
                  </div>
                  <div className="bg-muted/30 rounded-lg p-3">
                    <p className="text-sm text-muted-foreground">Mood</p>
                    <p className="text-lg font-medium capitalize">
                      {activeData.stats.mood}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      {getMetricDescription(
                        activeData.stats.brightness_percent,
                        "brightness",
                      )}
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <span className="text-sm font-mono">
                        {(
                          activeData.stats.colorfulness ||
                          calculateColorfulness(
                            activeData.stats.average_rgb[0],
                            activeData.stats.average_rgb[1],
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <span className="text-sm font-mono">
                        {(
                          activeData.stats.chroma ||
                          calculateChroma(...activeData.stats.average_rgb)
                        ).toFixed(1)}
                      </span>
                    </div>
                    <Progress
